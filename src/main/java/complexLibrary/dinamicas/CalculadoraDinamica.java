...
import complexLibrary.matricesComplejas.*;
...
public class CalculadoraDinamica {
     ...
     * @param tipo dinamica clasica, dinamica doblemente estocastica ó dinamica cuantica
     ...
     * @param t Potencia (exponente) que indica el numero de veces que se multiplicará la matriz con sí msima
