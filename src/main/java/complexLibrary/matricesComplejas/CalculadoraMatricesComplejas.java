...
public class CalculadoraMatricesComplejas {
     ...
     * @return Un vector de numeros complejos resultante de la suma de los
     * vectores A y B
     ...
     * @return Una matriz de numeros complejos resultante de la suma de las
     * matrices A y B
     ...
     * @param A Primera matriz de numeros complejos
     * @param B Segunda matriz de numeros complejos
     * @return Una matriz de numeros complejos resultante de la resta de las
     * matrices a y b
     * @throws ComplexException Si las matrices no tienen la misma dimension
     */
    ...
    /**
     * Calcula y retorna la inversa de una matriz, es decir, cada uno de sus
     * elementos (tanto parte real como parte imaginaria) por -1
     *
    ...
    /**
     * Realiza la multiplicaci�n entre dos matrices complejas
     *
