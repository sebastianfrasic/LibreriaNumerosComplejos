...
import complexLibrary.cuantica.Deutsch;
...
public class TransformacionesConH {
    ...
    public void ketUp() {
        ...
        try {
            ...
            ket = productoDeMatricesSinRedondear(crearHadamard(), ket);
