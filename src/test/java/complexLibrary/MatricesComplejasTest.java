...
public class MatricesComplejasTest {
    ...
    public void deberiaCalcularElInversoAditivoDeUnVector() throws ComplexException {
        ...
        assertEquals(CalculadoraMatricesComplejas.inversaDeUnVector(vector1), respuesta);

    }

    /**
     * Multiplicaci�n de escalar por vector complejo
     *
     * @throws ComplexException Si lo que se ingresa no es un vector
     */
    @Test
    public void deberiaMultiplicarUnEscalarPorUnVector() throws ComplexException {
        ...
        assertEquals(CalculadoraMatricesComplejas.productoPorEscalarDeUnVector(v1, escalar), respuesta);
    ...
    /**
     * Multiplicaci�n de escalar por matriz compleja
     */
    @Test
    ...
    /**
     * No se deberian multiplicar porque la matriz 1 es de tama�o 3x3, y la
     * matriz 2 es de tama�o 2x2
     */
    @Test
    ...
    /**
     * Acci�n de matriz compleja sobre vector complejo
     *
    ...
    /**
     * No deberia porque m1 es de tama�o 2x2 y m2 es de tama�o 2x1
     */
    @Test
    ...
    /**
     * Se le suma una matriz llena de valores en 0, la suma deberia dar como
    ...
    /**
     * No se deberian multiplicar porque la matriz 1 es de tama�o 2x2, y la
     * matriz 2 es de tama�o 1x2
     */
    @Test
    ...
    @Test
    public void deberiaCalcularElProductoTensor2() {
        MatrizCompleja M = new MatrizCompleja(2, 2);
        MatrizCompleja N = new MatrizCompleja(2, 2);

        try {
            M.addComplex(0, 0, new NumeroComplejo((double) 1 / 3, 0));
            M.addComplex(0, 1, new NumeroComplejo((double) 2 / 3, 0));
            M.addComplex(1, 0, new NumeroComplejo((double) 2 / 3, 0));
            M.addComplex(1, 1, new NumeroComplejo((double) 1 / 3, 0));

            N.addComplex(0, 0, new NumeroComplejo((double) 1 / 2, 0));
            N.addComplex(0, 1, new NumeroComplejo((double) 1 / 2, 0));
            N.addComplex(1, 0, new NumeroComplejo((double) 1 / 2, 0));
            N.addComplex(1, 1, new NumeroComplejo((double) 1 / 2, 0));

            //System.out.println(CalculadoraMatricesComplejas.productoTensor(M, N));
        } catch (ComplexException e) {
            e.printStackTrace();
        }
    }
